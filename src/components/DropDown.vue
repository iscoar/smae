...
<template>
    ...
    <button :id="'dropdown'+id" :data-dropdown-toggle="id"
        :class="class"
        class="text-gray-900 bg-[#3498db] hover:bg-[#3498db]/[.5] focus:ring-4 focus:outline-none focus:ring-[#3498db]/[1.5] font-medium rounded-lg text-sm px-5 py-4 text-center inline-flex items-center justify-between dark:bg-[#3498db] dark:hover:bg-[#3498db]/[.5] dark:focus:ring-[#3498db]/[.5]"
        type="button">
