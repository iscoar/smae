...
<template>
    ...
    <button :id="'dropdown'+id" :data-dropdown-toggle="id"
        :class="class"
        class="text-white bg-[#C8A2C8] hover:bg-[#C8A2C8]/[.5] focus:ring-4 focus:outline-none focus:ring-[#C8A2C8]/[1.5] font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:bg-[#C8A2C8] dark:hover:bg-[#C8A2C8]/[.5] dark:focus:ring-[#C8A2C8]/[.5]"
        type="button">
